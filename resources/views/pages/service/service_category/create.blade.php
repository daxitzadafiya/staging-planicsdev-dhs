            ...
            <div class="intro-y box p-5">
                <form action="{{ isset($serviceCategory) ? route('service-categories.update', $serviceCategory) : route('service-categories.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <input id="title" type="text" name="title" class="form-control w-full" value="{{ isset($serviceCategory->title) ? $serviceCategory->title : old('title') }}" placeholder="Please Enter Title">
                        @error('title')
